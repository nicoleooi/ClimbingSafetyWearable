# -*- coding: utf-8 -*-
"""
Created on Sat Jan 30 15:22:00 2021
...
def train_model(model, x_train, x_test, y_train, y_test, version):
    ...
    nu = 0.0001 #learning rate was 0.0001 before
...
def main():
    ...
    this is our perfect baby pls dont touch her
    '''
    n_in = 15
    n_out = 10
    
    #Format Data
    #x_train, x_test, y_train, y_test = format_data("","14.0", n_in, n_out)
    
    #Normalize Data
    x_train, x_test, y_train, y_test, scaler = normalize_data("14.0")
    ...
    #Train Model
    #model = train_model(model, x_train, x_test, y_train, y_test, "14.0")
    
    
    #Test Model
    test_model(model, scaler, x_train, x_test, y_train, y_test, "14.0", n_out)
...
def main_v10():
    ...
    #Format Data
    x_train, x_test, y_train, y_test = format_data("","13.0", n_in, n_out)
    ...
    #Network Architecture
    model = Sequential()
    #layer 1 = LSTM w 100 neurons
    model.add(LSTM(100, return_sequences = True, input_shape = (x_train.shape[1], 1)))
    #layer 2 = LSTM w 100 neurons
    ...
    #Train Model
    model = train_model(model, x_train, x_test, y_train, y_test, "13.0")

def make_graph():
    graph("real_time_HR_v3.0.csv", "mse")
    
if __name__ == "__main__":
<<<<<<< HEAD:scripts/HR Model/HR_LSTM.py
    main_v5()
=======
    main()
>>>>>>> 863f561 (final LSTM finished):scripts/HR_Model/SA_TE_LSTM.py
